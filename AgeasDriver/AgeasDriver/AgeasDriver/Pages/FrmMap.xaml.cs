...
namespace AgeasDriver.Pages
{
    public partial class FrmMap : PhoneApplicationPage
    {
        ...
        private void Map_Loaded(object sender, RoutedEventArgs e)
        {
            ...
            AddPinOnMap();
            DrawLinePathOnMap();
            //gestureBase = new MapGestureBase(mapJourney);
        ...
        void routeQuery_QueryCompleted(object sender, QueryCompletedEventArgs<Route> e)
        {
                ...
                //if (mapRoute != null) mapJourney.RemoveRoute(mapRoute);
                //if (e.Result != null)
                //{
            try
            {
        ...
        {
            //getureR.SuppressMapGestures = false;
        ...
        protected override void OnNavigatedTo(System.Windows.Navigation.NavigationEventArgs e)
        {
            ...
            try
            {
                ...
                ImgMapSelect.Source = new System.Windows.Media.Imaging.BitmapImage(ClsCommon.GetScaledImageUri("/Images/General/mapActive"));
                ImgGrapDeselect.Source = new System.Windows.Media.Imaging.BitmapImage(ClsCommon.GetScaledImageUri("/Images/General/graph"));
                ...
                //ImgHeader.Source = new System.Windows.Media.Imaging.BitmapImage(ClsCommon.GetScaledImageUri("/Images/General/quote"));
                //getureR.touch  = true;
