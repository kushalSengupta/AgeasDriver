...
namespace AgeasDriver
{
    public partial class App : Application
    {
        ...
        internal static FacebookSession fbSession = null;
        ...
        public static Geolocator objGeolocator { get; set; }
        public static bool IsJourneyStartStage = true;
        ...
        private void CompleteInitializePhoneApplication(object sender, NavigationEventArgs e)
        {
            ...
            try
            {
                ...
                if (!objDBHelper.IsDatabaseExists())
                {
                    if (!objDBHelper.CreateDatabase())
                    {
                        if (Guide.IsVisible == false)
                            Guide.BeginShowMessageBox("AgeasDriver", AgeasDriver.Resources.AppResources.UNABLE_TO_CREATE_DB, new string[] { AgeasDriver.Resources.AppResources.MESSAGE_BOX_BUTTON_OK }, 0, MessageBoxIcon.Error, null, null);
    ...
    class Constants
    {
        public static readonly string FacebookAppId = "482270025187410";
    }
}